...
//    sine : null,
    ...
    clear : function () {  // method to clear values from all properties 
        ...
        this.isClick = false;
        this.isSwipe = false;
//        this.PxPerFt = 5; don't clear this variable becuse it is set in the init() and never needs to be set again
...
console.log("isClick:" +  this.isClick + "  isSwipe:" + this.isSwipe);
        if (this.isClick) {
...
console.log("basket_x:" + court.basket_x + "  basket_y:" + court.basket_y)
        // chg_x and chg_y refer to the actual swipe, not the shot measurements.
        // at the bottom of the function are shot_chg_x and  shot_chg_y that measure the shot
        chg_x = parseInt(this.endX, 10) - parseInt(this.startX, 10);
        chg_y = parseInt(this.endY, 10) - parseInt(this.startY, 10);
console.log("chg_x:" + chg_x + "  chg_y:" + chg_y);        
...
//        this.shotSine = (parseInt(chg_y, 10) / parseInt(this.hypPx, 10)).toFixed(6);
console.log("Swipe data -- hypPx:" + this.hypPx + "  hypFt:" + this.hypFt + "  shotSine:" + this.shotSine);       
        if (isNaN(this.hypPx) || this.hypPx <= 5) {
            this.isClick = true;
            this.isSwipe = false;
        ...
        if (this.isShot) {
            ...
            this.shotSine = (isNaN((shot_chg_y / this.shotHypPx).toFixed(6))) ? 0 : (shot_chg_y / this.shotHypPx).toFixed(6);
        }
    }
